...
import com.tencent.angel.ml.lda.get.LikelihoodParam;
...
public class LikelihoodFunc extends GetFunc {
  ...
  public LikelihoodFunc(int matrixId, float beta) {
    super(new com.tencent.angel.ml.lda.get.LikelihoodParam(matrixId, beta));
  }
  ...
  public PartitionGetResult partitionGet(PartitionGetParam partParam) {
    ...
    com.tencent.angel.ml.lda.get.LikelihoodParam.LikelihoodPartParam param = (LikelihoodParam.LikelihoodPartParam) partParam;
